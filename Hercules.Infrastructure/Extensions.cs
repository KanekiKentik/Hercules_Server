...
public static class InfrastructureExtensions
{
    ...
    public static void AddDb(this IServiceCollection services, string? connString)
    {
    ...
    public async static void SeedData(this IServiceProvider provider, IConfiguration config)
    {
        var seed = config.GetSection("SeedingData").Get<SeedingData>();
        if (seed == null) throw new InvalidOperationException("Null seed exception");
